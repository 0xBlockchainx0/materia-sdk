...
import IMateriaV2Pair from '@materia-dex/materia-contracts-core/build/IMateriaPair.json';
...
var FACTORY_ADDRESS = '0x87ECe4fA34927851241DB2D6C73fC249F1f89f13';
var ORCHESTRATOR_ADDRESS = '0xc94150F4069414526dEee95236bA0109DC97bBFf';
...
var IETH = (_IETH = {}, _IETH[ChainId.MAINNET] = /*#__PURE__*/new Token(ChainId.MAINNET, '0x1D6316dbbE18b6E9B75AE064aA114FE7dC208eDC', 18, 'IETH', 'EthereumItem'), _IETH[ChainId.ROPSTEN] = /*#__PURE__*/new Token(ChainId.ROPSTEN, '0xEDf7dE64832b6D0998fE7E7D556A38005B994565', 18, 'IETH', 'EthereumItem'), _IETH[ChainId.RINKEBY] = /*#__PURE__*/new Token(ChainId.RINKEBY, ZERO_ADDRESS, 18, 'IETH', 'EthereumItem'), _IETH[ChainId.GÖRLI] = /*#__PURE__*/new Token(ChainId.GÖRLI, ZERO_ADDRESS, 18, 'IETH', 'EthereumItem'), _IETH[ChainId.KOVAN] = /*#__PURE__*/new Token(ChainId.KOVAN, ZERO_ADDRESS, 18, 'IETH', 'EthereumItem'), _IETH);
...
var Route = /*#__PURE__*/function () {
  function Route(pairs, input, output) {
    ...
    !(input instanceof Token && pairs[0].involvesToken(input) || input === ETHER && pairs[0].involvesToken(IETH[pairs[0].chainId])) ? process.env.NODE_ENV !== "production" ? invariant(false, 'INPUT') : invariant(false) : void 0;
    !(typeof output === 'undefined' || output instanceof Token && pairs[pairs.length - 1].involvesToken(output) || output === ETHER && pairs[pairs.length - 1].involvesToken(IETH[pairs[0].chainId])) ? process.env.NODE_ENV !== "production" ? invariant(false, 'OUTPUT') : invariant(false) : void 0;
...
var Fetcher = /*#__PURE__*/function () {
  ...
  Fetcher.fetchPairData = function fetchPairData(tokenA, tokenB, provider) {
    try {
      ...
      return Promise.resolve(new Contract(address, IMateriaV2Pair.abi, provider).getReserves()).then(function (_ref) {
