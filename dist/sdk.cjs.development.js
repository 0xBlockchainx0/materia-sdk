...
var ChainName = (_ChainName = {}, _ChainName[exports.ChainId.MAINNET] = 'mainnet', _ChainName[exports.ChainId.ROPSTEN] = 'ropsten', _ChainName[exports.ChainId.RINKEBY] = 'rinkeby', _ChainName[exports.ChainId.GÖRLI] = 'goerli', _ChainName[exports.ChainId.KOVAN] = 'kovan', _ChainName); // export const FACTORY_ADDRESS = '0xB498a69fF7b9a73C58491d564Fc6a462b259c860'
...
var Router = /*#__PURE__*/function () {
  ...
  Router.formatNativeTokenValue = function formatNativeTokenValue(currencyAmount, decimals) {
    ...
    try {
      var nativeValue = JSBI.BigInt(units.parseUnits(value, decimals));
      return {
        value: nativeValue,
        error: false
      };
...
var Fetcher = /*#__PURE__*/function () {
  ...
  Fetcher.fetchPairData = function fetchPairData(tokenA, tokenB, provider) {
    try {
      ...
      return Promise.resolve(new contracts.Contract(address, IMateriaV2Pair.abi, provider).getReserves()).then(function (_ref) {
...
exports.ORCHESTRATOR_ADDRESS = ORCHESTRATOR_ADDRESS;
exports.Pair = Pair;
